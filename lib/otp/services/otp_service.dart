import 'package:firebase_auth/firebase_auth.dart' show FirebaseAuth, FirebaseAuthException, PhoneAuthCredential, PhoneAuthProvider, PhoneCodeSent;
...
class OtpService {
  ...
  static void sendVerification(String parsedPhone, int? codeSentForceResendingToken, PhoneCodeSent cbCodeSent) {
    auth.verifyPhoneNumber(
      ...
      codeAutoRetrievalTimeout: (String verificationId) => print(verificationId),
    );
  }
