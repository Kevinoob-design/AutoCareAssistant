...
class _LineChartSample2State extends State<LineChartSample2> {
  List<Color> gradientColors = [kPrimaryColor, kPrimaryColor];
      ...
      children: <Widget>[
        ...
        SizedBox(
          ...
          child: TextButton(
            ...
            child: Text(
              'avg',
              style: TextStyle(fontSize: 12, color: showAvg ? Colors.white.withValues(alpha: 0.5) : Colors.white),
            ),
          ),
        ),
      ],
    ...
    return LineChartData(
      gridData: FlGridData(
        ...
        getDrawingHorizontalLine: (value) {
          return const FlLine(color: kPrimaryColor, strokeWidth: 1);
        },
  ...
  LineChartData avgData() {
    return LineChartData(
      ...
      titlesData: FlTitlesData(
        ...
        leftTitles: AxisTitles(
          sideTitles: SideTitles(showTitles: true, getTitlesWidget: leftTitleWidgets, reservedSize: 42, interval: 1),
        ),
        topTitles: const AxisTitles(sideTitles: SideTitles(showTitles: false)),
        rightTitles: const AxisTitles(sideTitles: SideTitles(showTitles: false)),
      ),
