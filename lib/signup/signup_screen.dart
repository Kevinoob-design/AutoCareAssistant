            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Text("Register Account", style: TextStyle(color: Theme.of(context).primaryColor, fontSize: 24, fontWeight: FontWeight.bold)),
                  ...
                  Row(
                    ...
                    children: [
                      SocalCard(icon: SvgPicture.string(googleIcon), press: () {}),
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 16),
                        child: SocalCard(icon: SvgPicture.string(facebookIcon), press: () {}),
                      ),
                      SocalCard(icon: SvgPicture.string(twitterIcon), press: () {}),
                    ],
                  ),
                  const SizedBox(height: 16),
                  const Text(
...
const googleIcon = '''<svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const facebookIcon = '''<svg width="8" height="15" viewBox="0 0 8 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const twitterIcon = '''<svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
